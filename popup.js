...
<span class="username">' + content.stream.channel.display_name + '</span> joue à <span>' + content.stream.channel.game + '</span>\n\
</div>';
...
<span class="username">' + content.livestream[0].media_display_name + '</span> joue à <span>' + content.livestream[0].category_name + '</span>\n\
</div>';
		document.getElementById("onlineList").appendChild(e);
		var onlineNumber = document.getElementById('online');
		onlineNumber.innerHTML = parseInt(onlineNumber.innerHTML) + 1;
